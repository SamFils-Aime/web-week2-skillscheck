...
var me = {
	...
	state: "texas",
	age: 25,
	greeter: function greeter(NAMEVALUE,STATEVALUE){  return "Hello! My name is "+NAMEVALUE+" and I live in "+STATEVALUE}
}
...
for(i=0; i<arr.length; i++){ 
	if(100 >= arr[i]){answers.push('small')}
...
// Code Here
var total = myNumbers.reduce((tot,num)=> tot+num )
//////////////////PROBLEM 17////////////////////
...
// Code Here
var myNumbersIndex = []
var x = myNumbers.forEach(item => myNumbersIndex.push(item))
...
// Code Here
var forTheLoveOfGeorge = notGeorge.map(nam => nam = "George")
...
// Code Here
var totallyAwsome = function (){ people.reduce(
	(tot,val) => tot+= val.awesomeLevel
)
	return tot}