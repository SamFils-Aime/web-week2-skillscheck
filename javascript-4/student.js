...
// CODE HERE
var faveColors = ["white","red","black"]
//////////////////Step 2////////////////////
...
var me = {
    name: "Sam",
    superHeroName: "salami",
    homeTown: "Deli",
    superPowers: ["lettuce","banana peppers","guacamole"],
...
function setPowers (arr) {
    ...
    for (i=0 ; i<arr.length ; i++ ){createLi(arr[i])}
}
